...
def enforce_expected_data_directory_tree(data_directory_parent=Path('.')):
    ...
    data_directory.joinpath('lightcurves/magnitudes').mkdir(exist_ok=True, parents=True)
    data_directory.joinpath('lightcurves/pars').mkdir(exist_ok=True, parents=True)
    data_directory.joinpath('lightcurves/py_initialize').mkdir(exist_ok=True, parents=True)
